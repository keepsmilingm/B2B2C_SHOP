...
public class BuyerDaoImpl implements BuyerDao{
	...
	public BuyerBean queryById(int B_id) {
		...
		try {
			conn = JDBCPoolUtil.getConn();
			String sql = "select * from tb_buyer where B_id = ?";
			pst = conn.prepareStatement(sql);
			pst.setInt(1, B_id);
...
//			pst.setString(1, getUsername(B_id));
//			pst.setString(2, getPassword(B_id));
//			pst.setString(3, getPhone(B_id));
//			pst.setString(4, getNickname(B_id));
//			pst.setString(5, null);
//			pst.setString(6, getHeadportrait(B_id));
//			pst.setString(7, getIntro(B_id));
